...
const sequelize = new Sequelize('sys', 'root', 'yasirsql27', {
  host: 'localhost',
  dialect: 'mysql',
});
        ...
        },
        {
          ...
          include: [
            ...
            },
            {
              ...
              attributes: ['judgmentsCitedRefferedCitation', 'judgmentsCitedParties', 'judgmentsCitedParaLink', 'judgmentsCitedText'],
              required: false
            }
          ]
        },
...
export async function getJudgmentsByMultipleCriteria(actKeywords, sectionKeywords, subsectionKeywords, topicKeywords, judgeKeywords, advocateKeywords) {
  ...
  try {
      ...
      if (sectionKeywords.length > 0) {
        mustQueries.push({
          bool: {
            should: sectionKeywords.map(keyword => ({
              match: { 'sections.legislationSectionName': keyword }
            }))
          }
        });
      }
