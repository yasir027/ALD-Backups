...
import NormalPrint from '../components/PDFManipulators/NormalPrint'; // Adjust the import path as needed
...
const IndexPage = () => {
  ...
  const handleContentChange = (content) => {
    // If the user is not logged in and tries to switch to any item except "headnotes", redirect them to /auth
    if (!user && content !== 'headnotes') {
      navigate('/auth');
    } else {
      // Otherwise, allow switching between content items
